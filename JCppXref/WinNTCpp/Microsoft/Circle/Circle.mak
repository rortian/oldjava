...
ALL : "$(OUTDIR)\Circle.exe"

CLEAN : 
	-@erase ".\Release\Circle.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /Fp"$(INTDIR)/Circle.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/Circle.pdb" /machine:I386 /out:"$(OUTDIR)/Circle.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Circle.obj"

"$(OUTDIR)\Circle.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /Fp"$(INTDIR)/Circle.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/Circle.pdb" /debug /machine:I386 /out:"$(OUTDIR)/Circle.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Circle.obj"
